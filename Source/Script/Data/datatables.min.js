 ...
 *   https://datatables.net/download/#dt/jq-3.7.0/dt-2.2.2/b-3.2.2/cr-2.0.4/fc-5.0.4/fh-4.0.1/kt-2.12.1/r-3.0.4/rg-1.5.1/rr-1.5.0/sc-2.4.3/sb-1.8.2/sp-2.3.3
 *
 * Included libraries:
 *  jQuery 3.7.0, DataTables 2.2.2, Buttons 3.2.2, ColReorder 2.0.4, FixedColumns 5.0.4, FixedHeader 4.0.1, KeyTable 2.12.1, Responsive 3.0.4, RowGroup 1.5.1, RowReorder 1.5.0, Scroller 2.4.3, SearchBuilder 1.8.2, SearchPanes 2.3.3
 */
			...
			((V.ext = T =
				{
					...
					classes: {},
					builder:
						"dt/jq-3.7.0/dt-2.2.2/b-3.2.2/cr-2.0.4/fc-5.0.4/fh-4.0.1/kt-2.12.1/r-3.0.4/rg-1.5.1/rr-1.5.0/sc-2.4.3/sb-1.8.2/sp-2.3.3",
					errMode: "alert",
					feature: [],
					features: {},
					search: [],
...
!(function (o) {
	...
	function a(t, e, o) {
		...
		if (!e.includes(o)) {
			h(i, e[0], e.length, o);
			var l = g(i);
			for (h(s, e[0], e.length, o), r = 0; r < n.aoData.length; r++) {
				var a = n.aoData[r];
				if (a) {
					var c = a.anCells;
					if (c)
						for (h(c, e[0], e.length, o), u = 0; u < c.length; u++)
							a.nTr &&
								c[u] &&
								s[u].bVisible &&
								a.nTr.appendChild(c[u]),
								c[u] &&
									c[u]._DT_CellIndex &&
									(c[u]._DT_CellIndex.column = u);
				}
			}
			for (r = 0; r < s.length; r++) {
				for (var d = s[r], u = 0; u < d.aDataSort.length; u++)
					d.aDataSort[u] = l[d.aDataSort[u]];
				(d.idx = l[d.idx]), d.bVisible && n.colgroup.append(d.colEl);
			}
			p(n.aoHeader, l, e, o),
				p(n.aoFooter, l, e, o),
				h(n.aoPreSearchCols, e[0], e.length, o),
				m(l, n.aaSorting),
				Array.isArray(n.aaSortingFixed)
					? m(l, n.aaSortingFixed)
					: (n.aaSortingFixed.pre || n.aaSortingFixed.post) &&
						m(l, n.aaSortingFixed.pre),
				n.aLastSort.forEach(function (t) {
					t.src = l[t.src];
				}),
				t.trigger("column-reorder", [
					t.settings()[0],
					{ from: e, to: o, mapping: l },
				]);
		}
	}
	function m(t, e) {
		if (e)
			for (var o = 0; o < e.length; o++) {
				...
				"number" == typeof r
					? (e[o] = t[r])
					: u.isPlainObject(r) && void 0 !== r.idx
						? (r.idx = t[r.idx])
						: Array.isArray(r) &&
							"number" == typeof r[0] &&
							(r[0] = t[r[0]]);
	...
	function c(t, e, o) {
		...
		if (e.length !== t.columns().count())
			...
			for (
				var n = g((e = o ? d(t, e, "toCurrent") : e)), s = 0;
				s < n.length;
				s++
			) {
				var i = n.indexOf(s);
				s !== i && (h(n, i, 1, s), a(t, [i], s), (r = !0));
			}
			r && l(t);
		}
	}
	...
	function y(t, e, o) {
		for (
			...
			h(r[n], e[0], e.length, o);
		for (n = 0; n < r.length; n++)
			for (var s = [], i = 0; i < r[n].length; i++) {
				var l = r[n][i];
				if (s.includes(l)) {
					if (s[s.length - 1] !== l) return;
				} else s.push(l);
			}
		return 1;
	}
	(_.prototype.disable = function () {
		...
		(_.prototype._createDragNode = function () {
			var t = this.s.mouse.target,
				...
				r = o.parent(),
				n = t.clone();
			this.dom.drag = u(r[0].cloneNode(!1))
				.addClass("dtcr-cloned")
				.append(
					u(o[0].cloneNode(!1)).append(
						u(e[0].cloneNode(!1)).append(n[0]),
					),
				)
				.css({
					position: "absolute",
		...
		(_.prototype._mouseDown = function (t, e) {
			for (
				...
				if (!s.includes(i[l])) return !1;
			(this.s.mouse.start.x = this._cursorPosition(t, "pageX")),
				(this.s.mouse.start.y = this._cursorPosition(t, "pageY")),
				(this.s.mouse.offset.x =
					this._cursorPosition(t, "pageX") - n.left),
				(this.s.mouse.offset.y =
					this._cursorPosition(t, "pageY") - n.top),
				(this.s.mouse.target = r),
				(this.s.mouse.targets = i);
			for (var a = 0; a < i.length; a++) {
				var c = this.dt
						.cells(null, i[a], { page: "current" })
						.nodes()
						.to$(),
					d = "dtcr-moving";
				0 === a && (d += " dtcr-moving-first"),
					a === i.length - 1 && (d += " dtcr-moving-last"),
					c.addClass(d);
			}
			this._regions(i),
				this._scrollRegions(),
		...
		(_.prototype._mouseMove = function (t) {
			if (null === this.dom.drag) {
				if (
					Math.pow(
						Math.pow(
							this._cursorPosition(t, "pageX") -
								this.s.mouse.start.x,
							2,
						) +
							Math.pow(
								this._cursorPosition(t, "pageY") -
									this.s.mouse.start.y,
								2,
							),
						0.5,
					) < 5
		...
		(_.prototype._mouseUp = function (t) {
			u(f).off(".colReorder"),
				u(f.body).removeClass("dtcr-dragging"),
				this.dom.drag &&
					(this.dom.drag.remove(), (this.dom.drag = null)),
		...
		(_.prototype._move = function (t, e) {
			var o,
				...
				i = this.s.dropZones.indexOf(t);
			t.left > e &&
				((r = t.left - e),
				(o = this.s.dropZones[i - 1]),
				(t.left -= r),
				(t.width += r),
				o) &&
				(o.width -= r),
				(t = this.s.dropZones.find(function (t) {
					return t.colIdx === s[s.length - 1];
				})).left +
					t.width <
					e &&
					((o = e - (t.left + t.width)),
					(r = this.s.dropZones[i + 1]),
					(t.width += o),
					r) &&
					((r.left += o), (r.width -= o));
		}),
		...
		(_.prototype._scrollRegions = function () {
			var e, o, r, n;
			this._isScrolling() &&
				((o = u((e = this).dt.table().container()).position().left),
				(r = u(this.dt.table().container()).outerWidth()),
	...
	return (
		...
		n.Api.register("colReorder.transpose()", function (t, e) {
			return i(this), d(this, t, (e = e || "toCurrent"));
		}),
		(n.ColReorder = b),
		u(f).on("stateLoadInit.dt", function (t, e, o) {
			if ("dt" === t.namespace) {
				t = new n.Api(e);
				if (o.colReorder)
					if (t.ready()) c(t, o.colReorder, !0);
					else if ((m(o.colReorder, o.order), o.columns)) {
		...
		u(f).on("preInit.dt", function (t, e) {
			var o, r;
			"dt" === t.namespace &&
				((t = e.oInit.colReorder),
				(r = n.defaults.colReorder),
				t || r) &&
				((o = u.extend({}, r, t)), !1 !== t) &&
...
!(function (n) {
	...
	"function" == typeof define && define.amd
		? define(
				["jquery", "datatables.net-dt", "datatables.net-colreorder"],
				function (e) {
					return n(e, window, document);
				},
			)
							...
							o.off("cancelOpen" + a),
								...
								o.one("close" + a, function () {
									s.keys.enable(!0),
										...
										o.off(a),
										c(s.table().container()).removeClass(
											"dtk-focus-alt",
										),
										i.s.returnSubmit &&
											((i.s.returnSubmit = !1),
											i._emitEvent("key-return-submit", [
												s,
												l,
											]));
								});
...
!(function (n) {
	...
	"function" == typeof define && define.amd
		? define(
				["jquery", "datatables.net-dt", "datatables.net-keytable"],
				function (e) {
					return n(e, window, document);
				},
			)
...
!(function (n) {
	...
	"function" == typeof define && define.amd
		? define(
				["jquery", "datatables.net-dt", "datatables.net-rowgroup"],
				function (e) {
					return n(e, window, document);
				},
			)
		: "object" == typeof exports
			? ((o = require("jquery")),
				(d = function (e, t) {
					t.fn.dataTable || require("datatables.net-dt")(e, t),
						t.fn.dataTable.RowGroup ||
							require("datatables.net-rowgroup")(e, t);
				}),
				"undefined" == typeof window
					? (module.exports = function (e, t) {
							return (
...
!(function (n) {
	...
	"function" == typeof define && define.amd
		? define(
				["jquery", "datatables.net-dt", "datatables.net-rowreorder"],
				function (e) {
					return n(e, window, document);
				},
			)
...
!(function (n) {
	...
	"function" == typeof define && define.amd
		? define(
				["jquery", "datatables.net-dt", "datatables.net-scroller"],
				function (e) {
					return n(e, window, document);
				},
			)
		: "object" == typeof exports
			? ((o = require("jquery")),
				(d = function (e, t) {
					t.fn.dataTable || require("datatables.net-dt")(e, t),
						t.fn.dataTable.Scroller ||
							require("datatables.net-scroller")(e, t);
				}),
				"undefined" == typeof window
					? (module.exports = function (e, t) {
							return (
...
!(function (e) {
	...
	function T(t, i, e, n, s, o, r) {
		...
		var a = this,
			i =
				((this.classes = B.extend(!0, {}, T.classes)),
				(this.c = B.extend(
					!0,
					{},
					T.defaults,
					B.fn.dataTable.ext.searchBuilder,
					i,
				)),
				this.c.i18n);
		if (
			...
			(this.dom = {
				...
				defaultValue: B("<select disabled/>")
	...
	return (
		...
		(T.prototype.getDetails = function (t) {
			...
			if (
				...
				if (null !== this.s.type && t) {
					...
					if (
						...
						this.s.type.includes("moment") ||
							(this.s.type.includes("datetime") && m))
					)
						...
						(this.s.type.includes("datetime") && f)
					)
						for (i = 0; i < this.s.value.length; i++)
							this.s.value[i] &&
								0 < this.s.value[i].length &&
								...
								(this.s.value[i] = s.DateTime.fromFormat(
									this.s.value[i],
									this.s.dateFormat,
				...
				for (i = 0; i < this.s.value.length; i++) {
					...
					if (
						("" !== e.oLanguage.sDecimal &&
							(o = this.s.value[i].split(e.oLanguage.sDecimal)),
						"" !== e.oLanguage.sThousands)
					)
						for (var r = 0; r < o.length; r++)
							o[r] = o[r].replace(e.oLanguage.sThousands, ",");
			...
			if (
				...
				void 0 !== t.data &&
					...
					this.dom.data.children("option").each(function () {
						...
						(B(this).text() === t.data ||
							(t.origData &&
								B(this).prop("origData") === t.origData))
							? (B(this).prop("selected", !0),
								n.removeClass(e),
								(s = !0),
								(i = parseInt(B(this).val(), 10)))
							: B(this).removeProp("selected");
					})),
				s)
			) {
				(this.s.data = t.data),
		...
		(T.prototype._populateCondition = function () {
			...
			if (0 === i) {
				(this.s.type = e.column(s).type()),
					void 0 !== n &&
						(void 0 !== (r = n[s]).searchBuilderType &&
						null !== r.searchBuilderType
							? (this.s.type = r.searchBuilderType)
							: (void 0 !== this.s.type &&
									null !== this.s.type) ||
								(this.s.type = r.sType)),
					(null !== this.s.type && void 0 !== this.s.type) ||
						(B.fn.dataTable.ext.oApi &&
							B.fn.dataTable.ext.oApi._fnColumnTypes(
								e.settings()[0],
							),
						(this.s.type = e.column(s).type())),
					this.dom.condition
				...
				var o,
					r = e.settings()[0].oLanguage.sDecimal,
					a =
						("" !== r &&
							this.s.type &&
							this.s.type.indexOf(r) ===
								this.s.type.length - r.length &&
							(this.s.type.includes("num-fmt") ||
								this.s.type.includes("num")) &&
							(this.s.type = this.s.type.replace(r, "")),
						void 0);
				void 0 !== this.c.conditions[this.s.type]
					? (a = this.c.conditions[this.s.type])
					: this.s.type && "datetime" === this.s.type
						? ((r = D.use("moment")),
							(o = D.use("luxon")),
							r &&
								((a = this.c.conditions.moment),
								(this.s.dateFormat =
									r().creationData().locale._longDateFormat.L)),
							o &&
								((a = this.c.conditions.luxon),
								(this.s.dateFormat = o.DateTime.DATE_SHORT)))
						: this.s.type && this.s.type.includes("datetime-")
							...
							: this.s.type && this.s.type.includes("moment")
								...
								: this.s.type && this.s.type.includes("luxon")
									? ((a = this.c.conditions.luxon),
										(this.s.dateFormat =
											this.s.type.replace(/luxon-/g, "")))
									: (a = this.c.conditions.string);
				for (var d, l, u = 0, c = Object.keys(a); u < c.length; u++)
					null !== a[(l = c[u])] &&
						(e.page.info().serverSide &&
							a[l].init === T.initSelect &&
							((d = n[s]),
							this.s.serverData && this.s.serverData[d.data]
								? ((a[l].init = T.initSelectSSP),
									(a[l].inputValue = T.inputValueSelect),
									(a[l].isInputValid = T.isInputValidSelect))
								: ((a[l].init = T.initInput),
									(a[l].inputValue = T.inputValueInput),
									(a[l].isInputValid = T.isInputValidInput))),
						(this.s.conditions[l] = a[l]),
						"function" == typeof (I = a[l].conditionName) &&
							(I = I(e, this.c.i18n)),
						t.push(
							B("<option>", { text: I, value: l })
				...
				this.dom.condition
					...
					.addClass(this.classes.italic);
				for (
					var h = 0, p = Object.keys(this.s.conditions);
					h < p.length;
					h++
				) {
					l = p[h];
					var m = this.s.conditions[l].conditionName,
						f =
							("function" == typeof m && (m = m(e, this.c.i18n)),
							B("<option>", { text: m, value: l })
								.addClass(this.classes.option)
								.addClass(this.classes.notItalic));
			...
			if (n[s].searchBuilder && n[s].searchBuilder.defaultCondition) {
				...
				if ("number" == typeof b)
					...
					for (var y = 0; y < t.length; y++)
						for (
							var C = 0, V = Object.keys(this.s.conditions);
							C < V.length;
							C++
						) {
							var I,
							...
							if (
								("string" ==
								typeof (I = this.s.conditions[w].conditionName)
									? I
									: I(e, this.c.i18n)) === t[y].text() &&
								w === b
							) {
								this.dom.condition
									.prop(
			...
			for (var e, n, s = 0; s < t.length; s++)
				(!0 !== this.c.columns && !i.includes(s)) ||
					...
					this.dom.data.append(
						B("<option>", { text: n.text, value: n.index })
							.addClass(this.classes.option)
							.addClass(this.classes.notItalic)
		...
		(T.prototype._populateValue = function (i) {
			...
			if (1 < r.length) for (t = 0; t < r.length; t++) B(r[t]).remove();
			for (
				void 0 !== i &&
			...
			for (
				var s = e.dom.data.children("option:selected").val(),
					...
					a =
						...
						B("<select/>")
							.addClass(T.classes.value)
							.addClass(T.classes.dropDown)
							.addClass(T.classes.italic)
							.addClass(T.classes.select)
		...
		(T.initSelectSSP = function (t, i, e) {
			...
			for (
				var n = B("<select/>")
						...
						.on("change.dtsb", function () {
							B(this).removeClass(T.classes.italic), i(t, this);
						}),
		...
		(T.initInput = function (i, e, t) {
			...
			return (
				i.c.greyscale && n.addClass(T.classes.greyscale),
				null !== t && n.val(t[0]),
		...
		(T.init2Input = function (i, e, t) {
			...
			return (
				i.c.greyscale &&
					(n[0].addClass(T.classes.greyscale),
		...
		(T.initDate = function (e, n, t) {
			...
			return (
				e.c.greyscale && i.addClass(T.classes.greyscale),
				null !== t && i.val(t[0]),
		...
		(T.init2Date = function (e, n, t) {
			...
			return (
				e.c.greyscale &&
					(o[0].addClass(T.classes.greyscale),
			...
			for (var i = !0, e = 0, n = t; e < n.length; e++) {
				...
				s.children("option:selected").length ===
					s.children("option").length -
						s.children("option." + T.classes.notItalic).length &&
		...
		(T.inputValueSelect = function (t) {
			for (var i = [], e = 0, n = t; e < n.length; e++) {
				...
				s.is("select") &&
					i.push(
						T._escapeHTML(
							s.children("option:selected").data("sbv"),
						),
					);
			}
			return i;
		...
		(i.Criteria = d),
		(i = D.Api.register),
		(D.ext.searchBuilder = { conditions: {} }),
		...
		i("searchBuilder.rebuild()", function (t, i) {
			var e = this.context[0];
			return void 0 === e._searchBuilder
				? null
				: (e._searchBuilder.rebuild(t, (i = void 0 === i ? !0 : i)),
					this);
		}),
		...
		s(t).on("preInit.dt.dtsp", function (t, i) {
			"dt" !== t.namespace ||
				(!i.oInit.searchBuilder && !D.defaults.searchBuilder) ||
				i._searchBuilder ||
				o(i);
		}),
		D.ext.feature.push({ cFeature: "Q", fnInit: o }),
...
!(function (e) {
		...
		if (l.select)
			return (
				...
				(this.dom = {
					...
					searchLabelCont: C("<div/>").addClass(
		...
		if (
			...
			return (
				b(n).on("draw.dt", function (t) {
					l.dom.container.find(t.target).length &&
						l._updateFilterCount();
				}),
				this._getState(),
				this.s.dt.page.info().serverSide &&
					...
					this.s.dt.on("preXhr.dtsps", function (t, s, e) {
						if (d === s) {
							void 0 === e.searchPanes && (e.searchPanes = {}),
								void 0 === e.searchPanes_null &&
									(e.searchPanes_null = {});
							for (
								var a = 0, i = l.s.selectionList;
								a < i.length;
								a++
							) {
								var n = i[a],
									o = l.s.dt.column(n.column).dataSrc();
								void 0 === e.searchPanes[o] &&
									(e.searchPanes[o] = {}),
			...
			t =
				(s.cascadePanes && s.viewTotal
					...
					: s.cascadePanes
						? (i = P)
						: s.viewTotal && (i = g),
				(n = j.call(this, t, s, (e = void 0 === e ? !1 : e), i) || this)
					.s.dt),
			o = t.state.loaded();
		return (
	...
	function N(s, e, t) {
		...
		s
			.button(e)
			.text(
				t.text || s.i18n("searchPanes.collapse", a.c.i18n.collapse, 0),
			),
			(t._panes = a);
	}
	function F(t, s, e) {
	...
	return (
		...
		(B.prototype.adjustTopRow = function () {
			...
			(C(t[0]).width() < 252 || C(a[0]).width() < 252) &&
			0 !== C(t[0]).width()
		...
		(B.prototype.collapse = function () {
			...
			this.s.displayed &&
				...
				(C(this.s.dtPane.table().container()).addClass(
					this.classes.hidden,
				),
		...
		(B.prototype.destroy = function () {
			...
			for (
				var t = C.fn.dataTable.ext.search.indexOf(
				...
				C.fn.dataTable.ext.search.splice(t, 1),
					(t = C.fn.dataTable.ext.search.indexOf(
						this.s.searchFunction,
					));
					...
					this.s.dt.on("stateSaveParams.dtsp", function (t, s, e) {
						if (C.isEmptyObject(e)) h.s.dtPane.state.clear();
							...
							h.s.dtPane &&
								...
								(n = h.dom.collapseButton.hasClass(
									h.classes.rotated,
								))),
				...
				this.dom.collapseButton
					...
					.on("click.dtsp", function (t) {
						...
						t.toggleClass(h.classes.hidden),
							...
							h.dom.nameButton.toggleClass(
								h.classes.disabledButton,
							),
							h.dom.countButton.toggleClass(
								h.classes.disabledButton,
							),
							h.dom.searchButton.toggleClass(
								h.classes.disabledButton,
							),
		...
		(B.prototype._serverPopulate = function (t) {
			...
			if (t.searchPanes.options[s])
				for (
					var e = 0, a = t.searchPanes.options[s];
					e < a.length;
					e++
				) {
					var i = a[e];
		...
		(B.prototype.show = function () {
			this.s.displayed &&
				...
				C(this.s.dtPane.table().container()).removeClass(
					this.classes.hidden,
				),
				this.dom.topRow.trigger("collapse.dtsps"));
		}),
		...
		(B.prototype._updateSelection = function (t) {
			function s(t) {
				T.versionCheck("2")
					? e.s.dt.processing(t)
					: (t = e.s.dt.settings()[0]).oApi._fnProcessingDisplay(
							t,
							!1,
						);
			}
		...
		(B.prototype._buildPane = function (t, s, e) {
				...
				e =
					...
					(r = C.fn.dataTable.versionCheck("2")
						? ((d = C.extend(
								!0,
								{},
								C.fn.dataTable.defaults.layout,
							)),
			...
			if (
				...
				for (
					var h = 0, c = this.s.rowData.arrayFilter.length;
					h < c;
					h++
				)
					...
					for (
						...
						(p = P[w]),
							this.s.dtPane.row(p).data() &&
								m.filter ===
									this.s.dtPane.row(p).data().filter &&
								(this.s.dt.page.info().serverSide
									? ((this.s.serverSelecting = !0),
		...
		(s.prototype._serverPopulate = function (t) {
			...
			if (void 0 !== t.searchPanes.options[e])
				for (
					var a = 0, i = t.searchPanes.options[e];
					a < i.length;
					a++
				) {
					var n = i[a];
		...
		(s.prototype._updateShown = function (t, a, s) {
			...
			if (Array.isArray(t))
				for (var n = 0, o = t; n < o.length; n++) e(o[n]);
			else e(t);
		}),
		(t = s),
		(
		...
		(L.prototype.updateRows = function () {
			...
			if (
				...
				for (
					var h = 0, c = this.s.rowData.arrayFilter;
					h < c.length;
					h++
				) {
					var p = c[h];
			...
			this.s.dt.on("stateLoadParams.dtsps", function (t, s, e) {
				if (void 0 !== e.searchPanes && s === h) {
					if (
						...
						for (
							var a = 0, i = e.searchPanes.panes;
							a < i.length;
							a++
						)
							for (
								var n = i[a], o = 0, r = d.s.panes;
								o < r.length;
								o++
							) {
								var l = r[o];
		...
		(k.prototype._checkCollapse = function () {
			for (
				var t = !0, s = !0, e = 0, a = this.s.panes;
				e < a.length;
				e++
			) {
				var i = a[e];
		...
		(k.prototype._makeSelections = function (t) {
			for (var s = 0, e = t; s < e.length; s++) {
				...
				if (i && i.s.dtPane) {
					for (
						var l = 0;
						l < i.s.dtPane.rows().data().toArray().length;
						l++
					)
						a.rows.includes(
				...
				var a = this,
					i =
						(t
							...
							.each(function (t) {
								a.s.panes.push(
									new a.s.paneClass(s, e, t, a.dom.panes),
								);
							}),
		...
		(k.prototype._startup = function (i) {
			...
			var a = this.s.dt.state.loaded(),
				n =
					(!this.s.stateRead &&
						a &&
						this.s.dt
							.page(a.start / this.s.dt.page.len())
							.draw("page"),
					(this.s.stateRead = !0),
					this._checkMessage(),
					...
					this.s.dt.page.info().serverSide
						? i
								.off("preXhr.dtsps")
								.on("preXhr.dtsps", function (t, s, e) {
									if (s === c) {
										e.searchPanes || (e.searchPanes = {}),
											e.searchPanes_null ||
												(e.searchPanes_null = {});
										for (
											var a = 0, i = 0, n = h.s.panes;
											i < n.length;
											i++
										) {
											var o = n[i],
			...
			a &&
				...
				i.on("destroy.dtsps", function (t, s) {
					if (s === c) {
						for (var e = 0, a = h.s.panes; e < a.length; e++)
							a[e].destroy();
						i.off(".dtsps"),
		...
		(k.prototype._updateFilterCount = function () {
			for (var t = 0, s = 0, e = 0, a = this.s.panes; e < a.length; e++) {
				var i = a[e];
				i.s.dtPane &&
					((t += i.getPaneCount()), i.s.dtPane.search()) &&
					s++;
			}
			this.dom.title.html(
			...
			for (var t = 0, s = this.s.panes; t < s.length; t++) {
				...
				if (e.s.colOpts.show) {
					...
					if (this.s.serverData.searchPanes.options[a])
						for (
							var n = 0,
								o = this.s.serverData.searchPanes.options[a];
							n < o.length;
							n++
						) {
							var r = o[n];
		...
		(M.prototype._stateLoadListener = function () {
			...
			var d = this;
			this.s.dt
				.off("stateLoadParams.dtsps", t)
				.on("stateLoadParams.dtsps", t);
		}),
		...
		(M.prototype._remakeSelections = function () {
			...
			if (((this.s.updating = !0), this.s.dt.page.info().serverSide)) {
				...
				for (var n = 0, o = this.s.panes; n < o.length; n++)
					(h = o[n]).s.displayed &&
						((h.s.filteringActive = i), h.updateRows());
				for (var r = 0, l = this.s.selectionList; r < l.length; r++) {
					...
					if (h.s.dtPane) {
						for (
							var f = h.s.dtPane.rows().indexes().toArray(),
								g = 0;
							g < d.rows.length;
							g++
						) {
		...
		(T.ext.buttons.searchPanes = {
			...
			init: function (t, s, e) {
				t
					...
					.text(
						e.text ||
							t.i18n("searchPanes.collapse", "SearchPanes", 0),
					),
		...
		: "object" == typeof exports
			? ((a = require("jquery")),
				...
				"undefined" == typeof window
					...
					: (d(window, a),
						(module.exports = t(a, window, window.document))))
			: t(jQuery, window, document);
})(function (e, n, t) {
	"use strict";
	return e.fn.dataTable;
