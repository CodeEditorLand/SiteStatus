...
const c = ({ Text: e = "", Font: a = 1 }) => {
	...
	{ default: u } = await e(
		async () => {
			const { default: e } = await import("./Pixel.AJ3_i4Rp.js");
			return { default: e };
		},
	...
	}, []),
	{
		...
		const {
			...
			onCleanup: a,
			onMount: n,
		} = await import("./web.CCnzT9kG.js").then((e) => e.s);
