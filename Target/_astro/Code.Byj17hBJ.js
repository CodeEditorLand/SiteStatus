const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/Pixel.BdW3ddoa.js","_astro/preload-helper.BelkbqnE.js","_astro/dev.DQ0JVKdb.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper.BelkbqnE.js';
import { g as getNextElement, t as template, u as use, i as insert } from './dev.DQ0JVKdb.js';
...
const {
  ...
  default: Pixel
} = await import('./Pixel.BdW3ddoa.js');return {
  default: Pixel
...
const {
  ...
  onCleanup,
  onMount
} = await import('./dev.DQ0JVKdb.js').then(n => n.k);return {
  createEffect,
  createSignal,
  onCleanup,
  onMount
...
//# sourceMappingURL=Code.Byj17hBJ.js.map
